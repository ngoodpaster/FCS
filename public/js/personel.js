...
$(document).ready(function() {
	memberTemplate("griffin777");
	memberTemplate("griffin766");
	memberTemplate("griffin721");
...
function memberTemplate(socket_id){
	...
	var container = $("<div> </div>").addClass("circle").addClass("member").attr("id", socket_id).css("border-color", getRandomColor());
	container.append("<img src='griffin.jpg' alt='firefighter' class='headshot' >")
	var desc = $("<p> </p>").text(socket_id);
	container.append(desc);
	$("#team").append(container);
	$("#" + socket_id).click(function(){ 
		openNav(this.id);
	});
